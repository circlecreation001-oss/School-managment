...
export class AcademicController {
  ...
  async listCourses(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.listCourses(req.user!.tenantId, await resolveBranch(req))); } catch (e) { next(e); }
  }
  async createCourse(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.createCourse(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async listClasses(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.listClasses(req.user!.tenantId, await resolveBranch(req), req.query.sessionId as string)); } catch (e) { next(e); }
  }
  ...
  async createSection(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.createSection(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async listSubjects(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.listSubjects(req.user!.tenantId, await resolveBranch(req), req.query.classId as string)); } catch (e) { next(e); }
  }
  async createSubject(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.createSubject(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async createSubjectGroup(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.createSubjectGroup(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async listClassTeachers(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.listClassTeachers(req.user!.tenantId, await resolveBranch(req))); } catch (e) { next(e); }
  }
  async assignClassTeacher(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.assignClassTeacher(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async assignSubjectTeacher(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.assignSubjectTeacher(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }

  // Promotion Rules
  async listPromotionRules(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.listPromotionRules(req.user!.tenantId, await resolveBranch(req))); } catch (e) { next(e); }
  }
  async createPromotionRule(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.createPromotionRule(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async listCalendarEvents(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.listCalendarEvents(req.user!.tenantId, await resolveBranch(req), req.query as any)); } catch (e) { next(e); }
  }
  async createCalendarEvent(req: Request, res: Response, next: NextFunction) {
    try { sendCreated(res, await academicService.createCalendarEvent(req.user!.tenantId, req.body.branchId, req.body, req.user!.id)); } catch (e) { next(e); }
  }
  ...
  async getTimetable(req: Request, res: Response, next: NextFunction) {
    try { sendSuccess(res, await academicService.getTimetable(req.user!.tenantId, req.query.classId as string)); } catch (e) { next(e); }
  }
}
