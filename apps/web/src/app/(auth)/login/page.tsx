    ...
    <div className="flex min-h-screen">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 items-center justify-center p-12">
        ...
        <div className="relative text-white max-w-md">
          ...
          <h2 className="text-4xl font-bold leading-tight mb-4">Complete School Management Platform</h2>
          <p className="text-blue-100 text-lg leading-relaxed mb-8">One platform to manage admissions, attendance, fees, exams, communication, and more - for every role in your institution.</p>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 bg-white dark:bg-slate-950">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Access your institute dashboard using the credentials provided by your institute.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="identifier" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Email / Username / Admission No. / Employee ID</label>
              <input id="identifier" type="text" value={identifier} onChange={(e) => setIdentifier(e.target.value)} required autoComplete="username"
                className="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-3.5 py-2.5 text-sm text-slate-900 dark:text-slate-50 placeholder-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="e.g. admin@schoolnex.in or STU2025001" />
            </div>
            <div>
              ...
              <div className="relative">
                <input id="password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required autoComplete="current-password"
                  className="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-3.5 py-2.5 pr-10 text-sm text-slate-900 dark:text-slate-50 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="Enter your password" />
            ...
            <button type="submit" disabled={isSubmitting} className="w-full rounded-lg bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-50 transition-all shadow-sm">
