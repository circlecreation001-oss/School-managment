...
export default function HomePage() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 w-full">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="text-center max-w-5xl mx-auto">
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 backdrop-blur-sm mb-8">
              ...
              <span className="text-xs font-medium text-blue-200">Trusted by 2,500+ Institutes â€¢ 15 Lakh+ Students Managed</span>
            </motion.div>
            ...
            <motion.p variants={fadeUp} className="mt-6 text-base sm:text-lg lg:text-xl text-slate-300/90 max-w-3xl mx-auto leading-relaxed">
              One platform to manage admissions, academics, finance, communication, website, and operations â€” for schools, colleges, coaching institutes, and universities.
            </motion.p>
              ...
              <div className="rounded-2xl bg-slate-900/80 overflow-hidden">
                ...
                <div className="h-72 sm:h-80 lg:h-[420px] bg-gradient-to-br from-slate-800 via-slate-800 to-slate-900 flex items-center justify-center relative">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <p className="text-slate-400 text-xs mt-1">Real-time analytics â€¢ Live attendance â€¢ Fee collection</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â• SUPPORTED INSTITUTES â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
            ...
            <motion.p variants={fadeUp} className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">From K-12 schools to competitive coaching centers â€” SchoolNex adapts to your workflow.</motion.p>
          </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { icon: 'ðŸ«', name: 'School ERP', desc: 'K-12 management' },
              { icon: 'ðŸŽ“', name: 'College ERP', desc: 'Higher education' },
              { icon: 'ðŸ›ï¸', name: 'University ERP', desc: 'Multi-campus' },
              { icon: 'ðŸ“š', name: 'Coaching Institute', desc: 'Batch & test series' },
              { icon: 'ðŸ“', name: 'SSC Coaching', desc: 'Government exams' },
              { icon: 'ðŸš†', name: 'Railway Coaching', desc: 'RRB preparation' },
              { icon: 'ðŸ¦', name: 'Banking Coaching', desc: 'IBPS & SBI prep' },
              { icon: 'ðŸ‘®', name: 'Police & Defence', desc: 'Physical + written' },
              { icon: 'âš–ï¸', name: 'UPSC / BPSC', desc: 'Civil services prep' },
              { icon: 'ðŸ©º', name: 'NEET Coaching', desc: 'Medical entrance' },
              { icon: 'âš™ï¸', name: 'JEE Coaching', desc: 'Engineering entrance' },
              { icon: 'ðŸ’¼', name: 'Commerce Coaching', desc: 'CA, CS, CMA, B.Com' },
              { icon: 'ðŸ’»', name: 'Computer Institute', desc: 'IT courses & certs' },
              { icon: 'ðŸŒ', name: 'Spoken English', desc: 'Language training' },
              { icon: 'ðŸŽ¯', name: 'Skill Development', desc: 'Vocational training' },
            ].map((inst) => (
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â• WEBSITE FEATURES â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="py-24 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
            ...
            <motion.p variants={fadeUp} className="mt-4 text-lg text-slate-600">Every SchoolNex subscription includes a modern, SEO-optimized institution website.</motion.p>
          </motion.div>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â• ERP FEATURES â•â•â•â•â•â•â•â•â•â•â• */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="space-y-3">
              <h3 className="text-sm font-bold text-red-600 uppercase tracking-wider mb-4">âŒ Without SchoolNex</h3>
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-bold text-emerald-600 uppercase tracking-wider mb-4">âœ… With SchoolNex</h3>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â• WHY CHOOSE â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5">
            {[
              { icon: 'â˜ï¸', title: 'Cloud Based' },
              { icon: 'ðŸ”’', title: 'Highly Secure' },
              { icon: 'âš¡', title: 'Lightning Fast' },
              { icon: 'ðŸ“ˆ', title: 'Scalable' },
              { icon: 'ðŸ“±', title: 'Mobile Apps' },
              { icon: 'ðŸ’¾', title: 'Auto Backup' },
              { icon: 'ðŸ¢', title: 'Multi Branch' },
              { icon: 'ðŸ‘¥', title: 'Role Based Access' },
              { icon: 'ðŸ’¬', title: 'WhatsApp API' },
              { icon: 'ðŸŽ¯', title: '24Ã—7 Support' },
            ].map((f) => (
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="flex flex-col md:flex-row items-center justify-center gap-4 max-w-4xl mx-auto">
            {['Admission','Student Mgmt','Attendance','Fee Collection','Examination','Results','Reports'].map((step, i) => (
              <motion.div key={step} variants={fadeUp} className="flex items-center gap-3">
                ...
                {i < 6 && <span className="hidden md:block text-slate-300 text-lg">â†’</span>}
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section id="pricing" className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { name: 'Starter', price: 'â‚¹4,999', period: '/mo', desc: 'For small institutes up to 500 students', features: ['500 Students','5 Staff Logins','Website','Basic Modules','Email Support','Cloud Backup'] },
              { name: 'Professional', price: 'â‚¹9,999', period: '/mo', desc: 'For growing institutes up to 2000 students', popular: true, features: ['2,000 Students','Unlimited Staff','Website + SEO','All Modules','WhatsApp + SMS','Mobile Apps','Priority Support','Multi Branch'] },
              { name: 'Enterprise', price: 'Custom', period: '', desc: 'For large organizations and universities', features: ['Unlimited Students','Unlimited Branches','Custom Domain','Dedicated Server','API Access','Custom Integrations','On-Premise Option','24Ã—7 Dedicated Support'] },
            ].map((plan) => (
              <motion.div key={plan.name} variants={fadeUp} className={`relative p-8 rounded-3xl border ${plan.popular ? 'border-blue-200 bg-gradient-to-b from-blue-50/50 to-white shadow-xl shadow-blue-500/5 ring-1 ring-blue-100' : 'border-slate-200 bg-white hover:shadow-lg'} transition-all duration-300`}>
                ...
                <ul className="mt-8 space-y-3">
                  {plan.features.map((f) => (<li key={f} className="flex items-center gap-2.5 text-sm text-slate-600"><span className="text-emerald-500 font-bold">âœ“</span>{f}</li>))}
                </ul>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="space-y-3">
            {[
              ...
              ['Is my data secure?','Absolutely. SchoolNex uses enterprise-grade encryption, automatic daily backups, and SOC2-compliant cloud infrastructure.'],
